...
```bash
echo "## [$(date '+%Y-%m-%d %H:%M:%S')]" >> ~/.openclaw/skill-logs/wechat-article-extractor/log.md
echo "- **User Request**: <what user asked>" >> ~/.openclaw/skill-logs/wechat-article-extractor/log.md
echo "- **Action**: <what this skill did>" >> ~/.openclaw/skill-logs/wechat-article-extractor/log.md
echo "" >> ~/.openclaw/skill-logs/wechat-article-extractor/log.md
```
